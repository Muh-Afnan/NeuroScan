...
class modeltrainingscreen(tk.Frame):
    ...
    def create_widget(self):
        ...
        # Momentum
        tk.Label(self.left_frame, text="Momentum:").grid(pady=5)
        self.momentum = tk.DoubleVar(value=0.937)
        tk.Entry(self.left_frame, textvariable=self.momentum).grid(pady=5)

        #weight Decay
        tk.Label(self.left_frame, text="Weight Decay:").grid(pady=5)
        self.weight_decay = tk.DoubleVar(value=0.0005)
        tk.Entry(self.left_frame, textvariable=self.weight_decay).grid(pady=5)
